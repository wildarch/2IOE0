...
public class MenuToggle extends UIButton {
    ...
    public MenuToggle(String text, int x, int y, int width, int height, Consumer<Boolean> handler) {
    ...
    public MenuToggle(String name, PositionState pos, Consumer<Boolean> handler) {
    ...
    public void draw(Hud hud) {
        ...
        hud.text(x + width /2, (int) (y + TEXT_SIZE + 10), TEXT_SIZE, Hud.Font.MEDIUM, NVG_ALIGN_CENTER, String.format("%1$s: %2$s", text, value ? "enabled" : "disabled"), TEXT_COLOR);
    }
